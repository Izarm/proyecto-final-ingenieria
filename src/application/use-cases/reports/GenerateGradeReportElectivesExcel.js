// src/application/use-cases/reports/GenerateGradeReportElectivesExcel.js
const ExcelJS = require('exceljs');

class GenerateGradeReportElectivesExcel {
    constructor(pool) {
        this.pool = pool;
    }
    ...
    async generateExcel({ period, academicYear, grade, groups, headTeacherName, subjects, students, gradesMap }) {
        ...
        const worksheet = workbook.addWorksheet('Notas Electivas');
        ...
        worksheet.getCell(4, 1).value = 'INFORME NOTAS AREA DEPORTIVA Y CULTURAL';
...
module.exports = GenerateGradeReportElectivesExcel;
