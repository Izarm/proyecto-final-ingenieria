...
-- ==========================================
-- Cómo importar:
--   Opción 1 (terminal): mysql -u root -p < base-de-datos.sql
--   Opción 2 (phpMyAdmin / DBeaver / MySQL Workbench): ejecutar este archivo completo
-- ==========================================
...
CREATE TABLE `grade_audit_logs` (
  ...
  `field`                 varchar(50) NOT NULL COMMENT 'Campo modificado',
